...
EchoServerImpl::EchoServerImpl(EventLoop *loop, const InetAddress &listenAddr,
  ...
  server_.setMessageCallback(
      bind(&EchoServerImpl::onMessage, this, _1, _2, _3));
  server_.setWriteCompleteCallback(
      bind(&EchoServerImpl::onWriteComplete, this, _1));
}

void EchoServerImpl::start() { server_.start(); }
...
void EchoServerImpl::onMessage(const TcpConnectionPtr &conn, Buffer *buf,
                               Timestamp time) {
